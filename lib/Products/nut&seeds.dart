...
class NutsView extends StatelessWidget {
  const NutsView({Key? key}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ItemWidget(
                          ...
                          image: const Image(
                            image: NetworkImage(
                                "https://www.americanseedco.com/wp-content/uploads/2013/03/bodacious.jpg"),
                            fit: BoxFit.cover,
                          ),
                          itemName: "Sweet Corn",
                          itemDetails: "Our Supper Sweert Corn is super fresh",
                          itemPrice: "Rs 90",
                          itemStock: "On Stock",
                          viewDetails: () {}),
                      ItemWidget(
