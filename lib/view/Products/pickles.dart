...
class PicklesView extends StatelessWidget {
  const PicklesView({Key? key}) : super(key: key);
                  ...
                  child: Column(
                    ...
                    children: [
                      ItemWidget(
                          ...
                          image: const Image(
                            image: NetworkImage(
                                "https://nepalesecentre.co.uk/uploads/products/product-1617276264.jpeg"),
                            fit: BoxFit.cover,
                          ),
                          itemName: "Mula ko achaar",
                          itemDetails:
                              "Our Supper mula ko achaar is super fresh",
                          itemPrice: "Rs 150",
                          itemStock: "On Stock",
                          viewDetails: () {}),
                      ItemWidget(
